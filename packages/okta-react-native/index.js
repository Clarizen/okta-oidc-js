...
export const authenticateWithAccessToken = async({accessToken, expirationDate}) => {
  return NativeModules.OktaSdkBridge.authenticateWithAccessToken(accessToken, expirationDate);
}
